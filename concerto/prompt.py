...
3. Lifecycle injection — auto-generated from config + GUS data
"""
...
from .config import GusStatusesConfig, ServiceConfig, StateConfig
...
def build_template_context(
    ...
    Args:
        issue: The GUS work item being worked on.
...
def build_lifecycle_section(
    ...
    gus_statuses: GusStatusesConfig,
    run: int = 1,
    ...
    Args:
        issue: The GUS work item.
        state_name: Internal state machine state name.
        state_cfg: Configuration for the current state.
        gus_statuses: GUS status name mappings.
    ...
    lines.append("---")
    lines.append("<!-- AUTO-GENERATED BY CONCERTO — DO NOT EDIT -->")
    lines.append("")
    ...
    lines.append(
        ...
        "the GUS work item describing what was done and any decisions made."
    )
    lines.append("")
    lines.append("<!-- END CONCERTO LIFECYCLE -->")
